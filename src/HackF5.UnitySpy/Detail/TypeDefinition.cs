namespace HackF5.UnitySpy.Detail
{
    ...
    public class TypeDefinition : MemoryObject, ITypeDefinition
    {
            ...
            : base(image, address)
        {
            ...
            this.VTableSize = vtablePtr == Constants.NullPtr ? 0 : this.ReadInt32(MonoLibraryOffsets.TypeDefinitionVTableSize);
        ...
        public TValue GetStaticValue<TValue>(string fieldName)
        {
            ...
            {
                MemoryReadingUtils memReader = new MemoryReadingUtils(this.Process);
                //memReader.ReadMemory(this.VTable, 200, 4, 1);
            }

            try
            {
                return field.GetValue<TValue>(this.Process.ReadPtr(this.VTable + MonoLibraryOffsets.VTable + 8 * this.VTableSize));
            } 
            catch (Exception e)
            {
                throw new Exception(
        ...
        private IReadOnlyList<FieldDefinition> GetFields()
        {
            ...
            {
                MemoryReadingUtils memReader = new MemoryReadingUtils(this.Process);
                //memReader.ReadMemory(Address + MonoLibraryOffsets.TypeDefinitionFields + 0x20, 200, 4, 1);
            }
            ...
            {
                MemoryReadingUtils memReader = new MemoryReadingUtils(this.Process);
                //memReader.ReadMemory(firstField, 1024, 4, 0);
            }
            ...
            else
            {
                ...
                {
                    var field = IntPtr.Add(firstField, fieldIndex * MonoLibraryOffsets.TypeDefinitionFieldSize);
        ...
        private TypeDefinition GetGeneric()
        {
            ...
            MemoryReadingUtils memReader = new MemoryReadingUtils(this.Process);
            //memReader.ReadMemory(Address + MonoLibraryOffsets.TypeDefinitionSizeOf - 0x10, 200, 2, 1);  
